...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=172.16.20.230; Initial Catalog=AdventureWorksLT2019;TrustServerCertificate=True; Persist Security Info=True;User ID=Etudiant;Password=Qwerty123!", x => x.UseNetTopologySuite());
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
            ...
            entity.ToTable("Address", "SalesLT", tb =>
                {
                    ...
                    tb.HasTrigger("trgProvince");
                });

            entity.HasIndex(e => e.Rowguid, "AK_Address_rowguid").IsUnique();

            entity.HasIndex(e => new { e.AddressId, e.CountryRegion }, "nci_AdresseID_CountryRegion");

            entity.HasIndex(e => new { e.CountryRegion, e.AddressId }, "nci_CountryRegion_AdresseID");
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.ModifiedDate, "NCI_TEST");

            entity.HasIndex(e => e.CustomerId, "nci_CustomerID");
