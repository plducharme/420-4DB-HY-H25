...
public partial class ApplicationDBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=172.16.20.230;Initial Catalog=4DB_PROGRAMMINGEFDB1;Persist Security Info=True;User ID=Etudiant;Password=Qwerty123!;TrustServerCertificate=True", x => x.UseNetTopologySuite());
